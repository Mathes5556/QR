...
(function() {
  ...
  var Piechart, pie, prehod_na_stupne;

  prehod_na_stupne = function(hodnota) {
  ...
  Piechart = (function() {
    ...
    function Piechart() {
      var data, option;
      alert(data = this.make_data);
      alert(option = this.set_options);
    }
    ...
    Piechart.prototype.drawpieChart = function() {
      ...
      return one_chart.draw(data, options);
    };

    Piechart.prototype.make_date = function() {
      return alert('lol');
    };

    Piechart.prototype.set_options = function() {
      var options;
      return options = {
        title: 'pomer nalady',
        width: 400,
    ...
    Piechart.prototype.sprav_ajax_dotaz = function(data) {
      $.ajax({
        type: "POST",
        url: "/jpie/vsetky/vsetky",
        success: this.uspesny_ajax(d, data),
        dataType: "json"
      });
      alert($.ajax(["success"]));
      return $.ajax(["success"]);
    ...
    Piechart.prototype.uspesny_ajax = function(data_zo_servra, data_pre_graf) {
      var uspech;
      uspech = function(data_zo_servra, data) {
        ...
        return data_pre_graf.addRows([['zle', data_zo_servra.Bad]]);
      };
