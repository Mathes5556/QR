...
$(document).on('click', '.check_out', function() {
    ...
    // console.log($('#performance'+id_of_employee).val())
    perf = $('#performance'+id_of_employee).val();
    console.log(perf)
    ...
    var url = 'checkout/'+id_of_employee+'/'+perf
    console.log(url)
    $.ajax({
      type: "GET",
      url: url,
...
$('.zaskrtnute:checkbox').change(function() {
 ...
 $('#import_users').hide();
 $('#want_import_users').click(function(event) {
     $('#import_users').show();
 });
      ...
      <aside>
       ...
       <div class="col-md-9">
          ...
          <div class="panel panel-default">
            ...
            <!--    form pre import usrov cez cvs -->
          <div class="panel panel-default" id="import_users">
            <form action="/procces_csv" method="post" accept-charset="utf-8"
                enctype="multipart/form-data">

              <label for="csv">csv of your employee in "name;surname;position;"</label>
                ...
                <br>
                  ...
                  <div class="col-md-5">
                           ...
                           <button type="button" class="btn btn-default" id="want_new_user">
                             ...
                             <button type="button" class="btn btn-default" id="want_import_users">
                                <span class="glyphicon glyphicon-plus oranzova"> </span>&nbsp
                               <span style="font-size: 1em"> Import users</span>
                            </button>
