...
class Employee(Base):
    ...
    def __init__(self, by_user, name, surname, position, age , lock_for_public, merital_status =None, sex =None, residence=None):
        self.user = by_user
        self.name = name
        ...
        self.lock_for_public = lock_for_public
    ...
    def has_hash(self, hash):
        return self.hash1 == hash or self.hash2 == hash